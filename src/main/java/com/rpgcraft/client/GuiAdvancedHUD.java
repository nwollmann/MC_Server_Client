...
/**
 * This is a class which was provided by the AdvancedHUD Mod. The code still needs to be updated for our custom UI.
...
public class GuiAdvancedHUD extends GuiIngameForge {
    ...
    /**
     * Called by the engine - renders the game overlay.
     */
    @Override
